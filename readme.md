...
This repo is a clone of the [Udacity Traffic Simulation project](https://github.com/udacity/CppND-Program-a-Concurrent-Traffic-Simulation)
with my answers for the C++ Nanodegree project 4.
